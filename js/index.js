...
nav.textContent = siteContent["nav"]["nav-item-2"];
nav.textContent = siteContent["nav"]["nav-item-3"];
nav.textContent = siteContent["nav"]["nav-item-4"];
nav.textContent = siteContent["nav"]["nav-item-5"];
...
contactClass.textContent = siteContent["contact"]["contact-h4"];
contactClass.textContent = siteContent["contact"]["address"];
contactClass.textContent = siteContent["contact"]["phone"];
contactClass.textContent = siteContent["contact"]["email"];
